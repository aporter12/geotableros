...
function guardarLugar(){
	...
	//Cadena de variables
	variables = 'nombre=' + nombre.value + '&precio=' + precio.value + '&descripcion=' + 
				descripcion.value + '&categoria=' + categoria.value + '&longitud=' + longitud + 
				'&latitud=' + latitud + '&idTablero=' + idTablero;
